...
export default function UtilityBar() {
  return (
    <div className="hidden lg:flex h-9 bg-primary-container text-surface-white/70 font-label-form text-label-form items-center justify-between px-gutter-desktop max-w-[1280px] mx-auto w-full">
