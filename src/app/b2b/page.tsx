    ...
    <main className="w-full bg-surface-white">
      ...
      <section className="w-full bg-[#F8F4ED] py-20 px-gutter md:px-gutter-tablet lg:px-gutter-desktop border-b border-hairline">
        <div className="max-w-[1280px] mx-auto">
          <h2 className="font-headline-lg text-primary text-center mb-12">Who we supply</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <div className="bg-surface-white p-6 rounded-xl border border-hairline hover:border-primary/30 transition-colors">
              ...
              <h3 className="font-title-card text-primary mb-2">Hotels and resorts</h3>
            ...
            <div className="bg-surface-white p-6 rounded-xl border border-hairline hover:border-primary/30 transition-colors">
              ...
              <h3 className="font-title-card text-primary mb-2">Hostels and PG</h3>
            ...
            <div className="bg-surface-white p-6 rounded-xl border border-hairline hover:border-primary/30 transition-colors">
              ...
              <h3 className="font-title-card text-primary mb-2">Hospitals</h3>
            ...
            <div className="bg-surface-white p-6 rounded-xl border border-hairline hover:border-primary/30 transition-colors">
              ...
              <h3 className="font-title-card text-primary mb-2">Builders and projects</h3>
            ...
            <div className="bg-surface-white p-6 rounded-xl border border-hairline hover:border-primary/30 transition-colors">
              ...
              <h3 className="font-title-card text-primary mb-2">Interior designers</h3>
            ...
            <div className="bg-surface-white p-6 rounded-xl border border-hairline hover:border-primary/30 transition-colors">
              ...
              <h3 className="font-title-card text-primary mb-2">Furniture dealers</h3>
            ...
            <div className="bg-surface-white p-6 rounded-xl border border-hairline hover:border-primary/30 transition-colors">
              ...
              <h3 className="font-title-card text-primary mb-2">Schools and colleges</h3>
        ...
        <div className="max-w-[1280px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
            <div className="flex flex-col">
              <div className="w-12 h-12 rounded-full bg-[#EFE5D7] flex items-center justify-center text-primary font-headline-sm mb-6">1</div>
              <h3 className="font-headline-sm text-primary mb-3">No middleman markup</h3>
              <p className="font-body-regular text-slate">You buy directly from the unit that cuts the foam and stitches the cover. No distributor margins, no retail overheads factored into your bulk price.</p>
            </div>
            
            <div className="flex flex-col">
              <div className="w-12 h-12 rounded-full bg-[#EFE5D7] flex items-center justify-center text-primary font-headline-sm mb-6">2</div>
              <h3 className="font-headline-sm text-primary mb-3">Same specification every batch</h3>
              <p className="font-body-regular text-slate">National brands often change suppliers by region. Because we make it ourselves in Coimbatore, order 100 today and 50 next year, and the density and feel will be exactly the same.</p>
            </div>
            
            <div className="flex flex-col">
              <div className="w-12 h-12 rounded-full bg-[#DCA544]/20 flex items-center justify-center text-[#DCA544] font-headline-sm mb-6">3</div>
              <h3 className="font-headline-sm text-primary mb-3">Inspect the unit before you commit</h3>
              <p className="font-body-regular text-slate">Don't trust a brochure. You are welcome to visit our Chinniyampalayam facility, see the raw materials, and watch a sample mattress being built for your project.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="requirement-form" className="w-full bg-[#EFE5D7] py-20 px-gutter md:px-gutter-tablet lg:px-gutter-desktop border-b border-hairline scroll-mt-20">
        <div className="max-w-[1280px] mx-auto grid grid-cols-1 xl:grid-cols-12 gap-12 xl:gap-20">
          ...
          <div className="xl:col-span-5 flex flex-col justify-center">
            <h2 className="font-display-lg text-primary mb-6">What we need from you</h2>
            ...
            <div className="bg-surface-white p-8 rounded-2xl border border-hairline shadow-sm">
              <h3 className="font-title-card text-primary mb-4 border-b border-hairline pb-4">Terms for Institutional Orders</h3>
      ...
      <section className="w-full bg-surface-white py-20 px-gutter md:px-gutter-tablet lg:px-gutter-desktop">
        <div className="max-w-[1280px] mx-auto text-center">
          ...
          {/* Placeholder Logos (To be replaced with real client logos) */}
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16 opacity-60 grayscale">
            <div className="font-display-sm text-2xl font-bold text-primary">The Residency</div>
            <div className="font-display-sm text-2xl font-bold text-primary flex items-center gap-2">
              <span className="material-symbols-outlined text-3xl">local_hospital</span>
              PSG Hospitals
            </div>
            <div className="font-display-sm text-2xl font-bold text-primary">KGISL Infrastructure</div>
            <div className="font-display-sm text-2xl font-bold text-primary">Kumaraguru College</div>
          </div>
